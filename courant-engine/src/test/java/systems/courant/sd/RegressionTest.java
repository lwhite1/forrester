...
import static systems.courant.sd.measure.Units.MILLISECOND;
...
public class RegressionTest {
    ...
    public void quantityEqualsShouldWorkAcrossUnits() {
        ...
        Quantity km = new Quantity(1, systems.courant.sd.measure.Units.KILOMETER);
        Quantity m = new Quantity(1000, systems.courant.sd.measure.Units.METER);
        assertEquals(km, m);
