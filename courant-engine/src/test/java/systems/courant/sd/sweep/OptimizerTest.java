...
class OptimizerTest {
    ...
    private RunResult runGrowthModel(double growthRate) {
        ...
        systems.courant.sd.Simulation simulation =
                new systems.courant.sd.Simulation(model, DAY, Times.weeks(2));
    ...
    private RunResult runLogisticModel(double growthRate, double capacity) {
        ...
        systems.courant.sd.Simulation simulation =
                new systems.courant.sd.Simulation(model, DAY, Times.weeks(4));
        simulation.addEventHandler(runResult);
        simulation.execute();
