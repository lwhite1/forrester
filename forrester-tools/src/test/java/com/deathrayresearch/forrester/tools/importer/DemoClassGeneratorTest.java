...
class DemoClassGeneratorTest {
    ...
    void shouldGenerateMinimalModel() {
        ...
        String source = generator.generate(def, metadata, "TestDemo",
                "com.deathrayresearch.forrester.demo", "test.xmile",
                List.of(), List.of());

        assertThat(source).contains("package com.deathrayresearch.forrester.demo;");
    ...
    void shouldIncludeAllMetadataFields() {
        ...
        String source = generator.generate(def, metadata, "SirDemo",
                "com.deathrayresearch.forrester.demo.epidemiology", "sir.xmile",
                List.of(), List.of());
    ...
    void shouldGenerateConstants() {
        ...
        String source = generator.generate(def, metadata, "TestDemo",
                "com.deathrayresearch.forrester.demo", "test.mdl",
                List.of(), List.of());
