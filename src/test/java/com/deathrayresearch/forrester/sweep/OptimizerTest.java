...
class OptimizerTest {
    ...
    private RunResult runGrowthModel(double growthRate) {
        ...
        com.deathrayresearch.forrester.Simulation simulation =
                new com.deathrayresearch.forrester.Simulation(model, DAY, Times.weeks(2));
    ...
    private RunResult runLogisticModel(double growthRate, double capacity) {
        ...
        com.deathrayresearch.forrester.Simulation simulation =
                new com.deathrayresearch.forrester.Simulation(model, DAY, Times.weeks(4));
        simulation.addEventHandler(runResult);
        simulation.execute();
