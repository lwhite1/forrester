...
class ModelDefinitionFactoryTest {
    ...
    private static ModelDefinition buildWithCldAndMetadata() {
        ...
        return new ModelDefinition(
                ...
                base.stocks(), base.flows(), base.auxiliaries(), base.constants(),
    ...
    @Nested
    @DisplayName("applyConstantOverrides preserves CLD and metadata")
    class ApplyConstantOverrides {

        @Test
        void shouldPreserveCldVariables() {
            ModelDefinition def = buildWithCldAndMetadata();
            ModelDefinition overridden = ModelDefinitionFactory.applyConstantOverrides(
                    def, Map.of("Rate", 0.2));
        ...
        void shouldStillApplyOverride() {
            ...
            assertThat(overridden.constants()).hasSize(1);
            assertThat(overridden.constants().get(0).value()).isEqualTo(0.5);
        }
    }
    ...
    class CreateFactory {
        ...
        void shouldPreserveCldThroughFactoryPipeline() {
            ...
            // The factory calls applyConstantOverrides then embedSettings
    ...
    class EdgeCases {
        ...
        void shouldReturnSameDefinitionForEmptyOverrides() {
            ModelDefinition def = buildWithCldAndMetadata();
            ModelDefinition result = ModelDefinitionFactory.applyConstantOverrides(
                    def, Map.of());
