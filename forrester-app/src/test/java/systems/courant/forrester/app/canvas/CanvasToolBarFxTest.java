...
class CanvasToolBarFxTest {
    ...
    @Test
    @DisplayName("Clicking Constant button activates PLACE_CONSTANT tool")
    void clickConstantButton(FxRobot robot) {
        robot.clickOn("#toolConstant");
        assertThat(toolBar.getActiveTool()).isEqualTo(CanvasToolBar.Tool.PLACE_CONSTANT);
    }
