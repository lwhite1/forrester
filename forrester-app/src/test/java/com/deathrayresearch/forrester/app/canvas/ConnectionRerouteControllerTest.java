...
import com.deathrayresearch.forrester.app.canvas.ConnectionRerouteController.RerouteEnd;
import com.deathrayresearch.forrester.app.canvas.ConnectionRerouteController.RerouteHit;
...
class ConnectionRerouteControllerTest {
    ...
    void setUp() {
        ...
        canvasState.addElement("Source", ElementType.CONSTANT, 100, 100);
        canvasState.addElement("Target", ElementType.AUX, 500, 100);
        canvasState.addElement("NewSource", ElementType.CONSTANT, 500, 300);
