...
public class QuickstartDialog extends Stage {
    ...
    private TextFlow ideaTab() {
        return new TextFlow(
                ...
                plain("  \u2022 "),
                bold("Constant"),
                plain(" \u2014 a fixed parameter (room temperature, cooling rate)\n\n"),
    ...
    private TextFlow placeElementsTab() {
        return new TextFlow(
                ...
                bold("Place two Constants\n\n"),
                plain("Press "),
                mono("5"),
                plain(" to switch to the Constant tool.\n\n"),
    ...
    private TextFlow connectTab() {
        return new TextFlow(
                ...
                plain("  \u2022 Constants: Room Temperature (18), Cooling Rate (0.10)")
        );
    }
    ...
    private TextFlow nextStepsTab() {
        return new TextFlow(
                ...
                plain("  \u2022 "),
                bold("Constant"),
                plain(" \u2014 holds a fixed parameter (Room Temperature, Cooling Rate)\n"),
                plain("  \u2022 "),
                bold("Negative feedback"),
                plain(" \u2014 the system self-corrects toward equilibrium\n\n"),
