...
public class SdConceptsDialog extends Stage {
    ...
    private TextFlow overviewText() {
        return new TextFlow(
                ...
                plain(" are the primary notation. They show the physical and information "
                        + "structure of a system as a network of stocks, flows, auxiliaries, and constants "
    ...
    private TextFlow auxiliariesText() {
        return new TextFlow(
                ...
                bold("Constants"),
                plain(" are fixed parameter values that do not change during a simulation run. "
                        + "They represent assumptions or policy levers.\n\n"),
                bold("Lookup tables"),
