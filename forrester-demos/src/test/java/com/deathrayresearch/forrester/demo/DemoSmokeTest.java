...
class DemoSmokeTest {
    ...
    void coffeeCoolingDemo() {
        ...
        var coffee = new com.deathrayresearch.forrester.model.Stock("Coffee Temp", 100,
                com.deathrayresearch.forrester.measure.Units.DIMENSIONLESS);
        var cooling = com.deathrayresearch.forrester.model.Flow.create("Cooling",
                com.deathrayresearch.forrester.measure.Units.MINUTE, () ->
                        new com.deathrayresearch.forrester.measure.Quantity(
                                0.10 * (coffee.getValue() - 18),
                                com.deathrayresearch.forrester.measure.Units.DIMENSIONLESS));
        coffee.addOutflow(cooling);
        model.addStock(coffee);
        new Simulation(model, com.deathrayresearch.forrester.measure.Units.MINUTE,
                new Quantity(8, com.deathrayresearch.forrester.measure.Units.MINUTE)).execute();
    ...
    void exponentialDecayDemo() {
        ...
        var pop = new com.deathrayresearch.forrester.model.Stock("Population", 100,
                com.deathrayresearch.forrester.measure.Units.PEOPLE);
        var deaths = com.deathrayresearch.forrester.model.Flow.create("Deaths", DAY, () ->
                new Quantity(pop.getValue() / 80.0, com.deathrayresearch.forrester.measure.Units.PEOPLE));
    ...
    void exponentialGrowthDemo() {
        ...
        var pop = new com.deathrayresearch.forrester.model.Stock("Population", 100,
                com.deathrayresearch.forrester.measure.Units.PEOPLE);
        var births = com.deathrayresearch.forrester.model.Flows.linearGrowth("Births", DAY, pop, 0.04);
        var deaths = com.deathrayresearch.forrester.model.Flow.create("Deaths", DAY, () ->
                new Quantity(pop.getValue() * 0.03, com.deathrayresearch.forrester.measure.Units.PEOPLE));
    ...
    void negativeFeedbackDemo() {
        ...
        double goal = 860;
        double adjustTime = 8;
        var inventory = new com.deathrayresearch.forrester.model.Stock("Inventory", 100,
                com.deathrayresearch.forrester.measure.Units.DIMENSIONLESS);
        var ordering = com.deathrayresearch.forrester.model.Flow.create("Ordering", DAY, () ->
                new com.deathrayresearch.forrester.measure.Quantity(
    ...
    void sShapedGrowthDemo() {
        ...
        var pop = new com.deathrayresearch.forrester.model.Stock("Population", 10,
                com.deathrayresearch.forrester.measure.Units.PEOPLE);
        var births = com.deathrayresearch.forrester.model.Flow.create("Births", DAY, () ->
                new com.deathrayresearch.forrester.measure.Quantity(
    ...
    void sirDemo() {
        ...
        var s = new com.deathrayresearch.forrester.model.Stock("Susceptible", 1000,
                com.deathrayresearch.forrester.measure.Units.PEOPLE);
        var i = new com.deathrayresearch.forrester.model.Stock("Infectious", 10,
                com.deathrayresearch.forrester.measure.Units.PEOPLE);
        var r = new com.deathrayresearch.forrester.model.Stock("Recovered", 0,
                com.deathrayresearch.forrester.measure.Units.PEOPLE);
        var infect = com.deathrayresearch.forrester.model.Flow.create("Infection", DAY, () -> {
            double total = s.getValue() + i.getValue() + r.getValue();
            if (total == 0) return new Quantity(0, com.deathrayresearch.forrester.measure.Units.PEOPLE);
            double count = 8 * (i.getValue() / total) * 0.10 * s.getValue();
            return new Quantity(Math.min(count, s.getValue()),
                    com.deathrayresearch.forrester.measure.Units.PEOPLE);
        });
        var recover = com.deathrayresearch.forrester.model.Flow.create("Recovery", DAY, () ->
                new Quantity(i.getValue() * 0.20, com.deathrayresearch.forrester.measure.Units.PEOPLE));
        s.addOutflow(infect);
        i.addInflow(infect);
        i.addOutflow(recover);
        r.addInflow(recover);
    ...
    void predatorPreyDemo() {
        ...
        var prey = new com.deathrayresearch.forrester.model.Stock("Prey", 100,
                com.deathrayresearch.forrester.measure.Units.PEOPLE);
        var predators = new com.deathrayresearch.forrester.model.Stock("Predators", 10,
                com.deathrayresearch.forrester.measure.Units.PEOPLE);
        var preyBirths = com.deathrayresearch.forrester.model.Flow.create("Prey Births", DAY, () ->
                new Quantity(1.0 * prey.getValue(),
                        com.deathrayresearch.forrester.measure.Units.PEOPLE));
        var predation = com.deathrayresearch.forrester.model.Flow.create("Predation", DAY, () ->
                new Quantity(0.01 * prey.getValue() * predators.getValue(),
                        com.deathrayresearch.forrester.measure.Units.PEOPLE));
        var predBirths = com.deathrayresearch.forrester.model.Flow.create("Pred Births", DAY, () ->
                new Quantity(0.5 * 0.01 * prey.getValue() * predators.getValue(),
                        com.deathrayresearch.forrester.measure.Units.PEOPLE));
        var predDeaths = com.deathrayresearch.forrester.model.Flow.create("Pred Deaths", DAY, () ->
    ...
    void salesMixDemo() {
        ...
        var customers = new com.deathrayresearch.forrester.model.Stock("Customers", 0,
                com.deathrayresearch.forrester.measure.Units.PEOPLE);
        var acq = com.deathrayresearch.forrester.model.Flows.linearGrowth("New Customers", DAY, customers, 10);
        customers.addInflow(acq);
        model.addStock(customers);
        var hw = new com.deathrayresearch.forrester.model.Variable("HW Sales",
                com.deathrayresearch.forrester.measure.Units.US_DOLLAR,
                () -> 1000 * acq.flowPerTimeUnit(WEEK).getValue());
        double weeksPerMonth = 52.0 / 12.0;
        var svc = new com.deathrayresearch.forrester.model.Variable("Svc Sales",
                com.deathrayresearch.forrester.measure.Units.US_DOLLAR,
                () -> 10 / weeksPerMonth * customers.getValue());
        var total = new com.deathrayresearch.forrester.model.Variable("Total",
                com.deathrayresearch.forrester.measure.Units.US_DOLLAR,
                () -> hw.getValue() + svc.getValue());
        var proportion = new com.deathrayresearch.forrester.model.Variable("Proportion HW",
                com.deathrayresearch.forrester.measure.Units.DIMENSIONLESS,
    ...
    void tubDemo() {
        ...
        var water = new com.deathrayresearch.forrester.model.Stock("Water", 50,
                com.deathrayresearch.forrester.measure.Units.DIMENSIONLESS);
        var outflow = com.deathrayresearch.forrester.model.Flows.constant("Outflow",
                com.deathrayresearch.forrester.measure.Units.MINUTE,
                new Quantity(5, com.deathrayresearch.forrester.measure.Units.DIMENSIONLESS));
        water.addOutflow(outflow);
        model.addStock(water);
        var minute = com.deathrayresearch.forrester.measure.Units.MINUTE;
    ...
    void firstOrderDelayDemo() {
        ...
        double delay = 120;
        var current = new com.deathrayresearch.forrester.model.Stock("Current", 1000,
                com.deathrayresearch.forrester.measure.Units.PEOPLE);
        var lost = com.deathrayresearch.forrester.model.Flow.create("Lost", DAY, () ->
    ...
    void simplePipelineDelayDemo() {
        ...
        var wip = new com.deathrayresearch.forrester.model.Stock("WIP", 0,
                com.deathrayresearch.forrester.measure.Units.DIMENSIONLESS);
        var arrivals = com.deathrayresearch.forrester.model.Flows.constant("Arrivals", DAY,
                new Quantity(5, com.deathrayresearch.forrester.measure.Units.DIMENSIONLESS));
    ...
    void flowTimeDemo() {
        ...
        var hour = com.deathrayresearch.forrester.measure.units.time.TimeUnits.HOUR;
        var wip = new com.deathrayresearch.forrester.model.Stock("WIP", 1000,
                com.deathrayresearch.forrester.measure.Units.DIMENSIONLESS);
        var completions = com.deathrayresearch.forrester.model.Flow.create("Completions", hour, () ->
    ...
    void thirdOrderDelayDemo() {
        ...
        var hour = com.deathrayresearch.forrester.measure.units.time.TimeUnits.HOUR;
        var step1 = new com.deathrayresearch.forrester.model.Stock("Step 1", 100,
                com.deathrayresearch.forrester.measure.Units.DIMENSIONLESS);
        var step2 = new com.deathrayresearch.forrester.model.Stock("Step 2", 0,
                com.deathrayresearch.forrester.measure.Units.DIMENSIONLESS);
        var step3 = new com.deathrayresearch.forrester.model.Stock("Step 3", 0,
                com.deathrayresearch.forrester.measure.Units.DIMENSIONLESS);
        var flow12 = com.deathrayresearch.forrester.model.Flow.create("Step1->2", hour, () ->
                new Quantity(step1.getValue() / 7.0,
                        com.deathrayresearch.forrester.measure.Units.DIMENSIONLESS));
        var flow23 = com.deathrayresearch.forrester.model.Flow.create("Step2->3", hour, () ->
    ...
    void inventoryDemo() {
        ...
        var inventory = new com.deathrayresearch.forrester.model.Stock("Cars", 200,
                com.deathrayresearch.forrester.measure.Units.DIMENSIONLESS);
        var sales = com.deathrayresearch.forrester.model.Flow.create("Sales", DAY, () ->
                new Quantity(20, com.deathrayresearch.forrester.measure.Units.DIMENSIONLESS));
        var deliveries = com.deathrayresearch.forrester.model.Flow.create("Deliveries", DAY, () ->
                new Quantity(20, com.deathrayresearch.forrester.measure.Units.DIMENSIONLESS));
    ...
    void multiRegionSirDemo() {
        ...
        var s1 = new com.deathrayresearch.forrester.model.Stock("S1", 990,
                com.deathrayresearch.forrester.measure.Units.PEOPLE);
        var i1 = new com.deathrayresearch.forrester.model.Stock("I1", 10,
                com.deathrayresearch.forrester.measure.Units.PEOPLE);
        var r1 = new com.deathrayresearch.forrester.model.Stock("R1", 0,
                com.deathrayresearch.forrester.measure.Units.PEOPLE);
        var infect1 = com.deathrayresearch.forrester.model.Flow.create("Infection1", DAY, () -> {
        ...
        var recover1 = com.deathrayresearch.forrester.model.Flow.create("Recovery1", DAY, () ->
                new Quantity(i1.getValue() * 0.20, com.deathrayresearch.forrester.measure.Units.PEOPLE));
    ...
    void populationRegionAgeDemo() {
        ...
        var pop = new com.deathrayresearch.forrester.model.Stock("Pop", 500,
                com.deathrayresearch.forrester.measure.Units.PEOPLE);
        var births = com.deathrayresearch.forrester.model.Flows.linearGrowth("Births", DAY, pop, 0.003);
        var deaths = com.deathrayresearch.forrester.model.Flow.create("Deaths", DAY, () ->
                new Quantity(pop.getValue() * 0.008, com.deathrayresearch.forrester.measure.Units.PEOPLE));
        pop.addInflow(births);
        pop.addOutflow(deaths);
        model.addStock(pop);
