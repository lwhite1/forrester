...
public class StaffAllocation {
    ...
    public StaffAllocation(Variable totalWorkforce, Variable dailyTrainingOverhead,
        ...
        Variable plannedFractionOfStaffForQA =
                new Variable("Planned fraction of resources for QA", DimensionlessUnits.DIMENSIONLESS,
        ...
        Variable lossFromOverhead =
                new Variable("Loss from overhead", DimensionlessUnits.DIMENSIONLESS,
                        () -> overheadLoss);
