...
import systems.courant.shrewd.model.MultiArrayedStock;
import systems.courant.shrewd.model.Stock;
import systems.courant.shrewd.model.Subscript;
import systems.courant.shrewd.model.SubscriptRange;
...
public class PopulationRegionAgeDemo {
    ...
    public void run(double[] initialPopulations, double agingRate, double birthRate,
        ...
        run.addEventHandler(new CsvSubscriber(
                System.getProperty("java.io.tmpdir") + "/shrewd-population-region-age.csv"));
