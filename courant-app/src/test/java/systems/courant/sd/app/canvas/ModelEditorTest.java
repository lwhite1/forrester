...
class ModelEditorTest {
    ...
    class SetLiteralAuxValue {
        ...
        @Test
        void shouldUpdateLiteralAuxEquation() {
            ModelDefinition def = new ModelDefinitionBuilder()
                    .name("Test")
                    .constant("k", 0.5, "1/day")
                    .build();
    ...
    class ToModelDefinition {
        ...
        void shouldRoundTripFromDefinition() {
            ...
            assertThat(rebuilt.parameterNames()).containsExactly("k");
        }
    ...
    class UpdateModuleDefinition {
        ...
        void shouldReplaceDefinitionPreservingNameAndBindings() {
            ...
            assertThat(updated.definition().parameterNames()).containsExactly("k");
    ...
    class AddFromTemplate {
        ...
        @Test
        void shouldCopyLiteralAuxProperties() {
            ModelDefinition def = new ModelDefinitionBuilder()
                    .name("Test")
    ...
    class SirFlowSourceSink {
        ...
        void shouldPreserveFlowSourceAndSinkFromJson() {
            var serializer = new systems.courant.sd.io.json.ModelDefinitionSerializer();
            ModelDefinition def = new ModelDefinitionBuilder()
                    .name("SIR")
                    .stock("Susceptible", 1000, "Person")
                    .stock("Infectious", 10, "Person")
    ...
    class BindingConnectorGeneration {
        ...
        void shouldGenerateConnectorForInputBinding() {
            ...
            systems.courant.sd.model.def.ModuleInterface iface =
                    new systems.courant.sd.model.def.ModuleInterface(
                            List.of(new systems.courant.sd.model.def.PortDef("in", "u")),
                            List.of());
        ...
        void shouldGenerateConnectorForOutputBinding() {
            ...
            systems.courant.sd.model.def.ModuleInterface iface =
                    new systems.courant.sd.model.def.ModuleInterface(
                            List.of(),
                            List.of(new systems.courant.sd.model.def.PortDef("out", "u")));
            ModelDefinition moduleDef = new ModelDefinition(
                    "Module 1", null, iface,
                    List.of(), List.of(), List.of(),
                    List.of(), List.of(), List.of(), List.of(), null);
