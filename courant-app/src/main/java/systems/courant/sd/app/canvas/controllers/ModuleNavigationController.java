...
import systems.courant.sd.app.canvas.NavigationStack;
...
public final class ModuleNavigationController {
    ...
    public void fireNavigationChanged() {
    ...
    public List<NavigationStack.Frame> frames() {
        return navigationStack.frames();
    }

    private NavigationStack.Frame peek() {
        return navigationStack.peek();
    }

    public void push(NavigationStack.Frame frame) {
        navigationStack.push(frame);
    }

    public NavigationStack.Frame pop() {
     ...
     */
    public void showContextMenu(Canvas canvas, String elementName, CanvasState canvasState,
     ...
     */
    public void openDefinePortsDialog(String moduleName, ModelEditor editor,
     ...
     */
    public void openBindingsDialog(String moduleName, ModelEditor editor,
                            Runnable saveUndo, Runnable fireStatus) {
        Optional<ModuleInstanceDef> moduleOpt = editor.getModuleByName(moduleName);
        if (moduleOpt.isEmpty()) {
            return;
