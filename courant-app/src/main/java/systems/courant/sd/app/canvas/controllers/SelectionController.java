...
public final class SelectionController {
    ...
    public SelectionController(CopyPasteController copyPaste) {
     ...
     */
    public String createElementAt(double worldX, double worldY,
     ...
     */
    public void deleteSelected(ModelEditor editor, CanvasState canvasState, Runnable saveUndo) {
     ...
     */
    public void copy(ModelEditor editor, CanvasState canvasState) {
        if (editor == null) {
            return;
        }
     ...
     */
    public void cut(ModelEditor editor, CanvasState canvasState, Runnable saveUndo) {
        if (editor == null || canvasState.getSelection().isEmpty()) {
            return;
        }
        copyPaste.copy(canvasState, editor);
     ...
     */
    public boolean deleteConnection(ConnectionId connection, boolean isCausalLink,
     ...
     */
    public boolean applyRename(String oldName, String newName,
     ...
     */
    public void selectAndCenter(String name, CanvasState canvasState, Viewport viewport,
