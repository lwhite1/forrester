...
public final class ChartUtils {
    ...
    public static final java.util.List<String> SERIES_COLORS = java.util.List.of(SERIES_COLORS_ARRAY);

    /** Muted colors for ghost run overlays, one per retained run (max 5). */
    public static final java.util.List<String> GHOST_COLORS = java.util.List.of(
     ...
     */
    public static void saveNodeAsPng(Node node, String defaultFilename, Window owner) {
        if (node == null) {
            return;
        }
     ...
     */
    public static void showCsvSaveDialog(String title, String defaultFilename,
