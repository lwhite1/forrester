...
import systems.courant.sd.app.canvas.EquationHighlighter;
 ...
 * </ul>
 */
public final class CodeAreaEquationField implements EquationField {
    ...
    public CodeAreaEquationField(String initialText) {
