 ...
 */
public final class MarqueeController {
     ...
     */
    public CanvasRenderer.MarqueeState toRenderState() {
        if (!active) {
     ...
     */
    public void start(double worldX, double worldY, CanvasState state, boolean shiftDown,
               boolean hideAux) {
        active = true;
     ...
     */
    public void drag(double worldX, double worldY, CanvasState state) {
        endWorldX = worldX;
        endWorldY = worldY;
     ...
     */
    public void cancel(CanvasState state) {
        state.clearSelection();
