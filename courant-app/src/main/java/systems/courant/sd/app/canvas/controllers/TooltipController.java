...
public final class TooltipController {
     ...
     */
    public void update(String elementName, MouseEvent event, Node owner,
     ...
     */
    public void updateCloud(FlowEndpointCalculator.CloudHit cloudHit, MouseEvent event, Node owner) {
        if (cloudHit == null) {
            Tooltip.uninstall(owner, elementTooltip);
            elementTooltip.hide();
            return;
    ...
    public static String buildCloudTooltipText(FlowEndpointCalculator.CloudHit cloudHit) {
    ...
    public static void appendValidationMessages(StringBuilder sb, List<ValidationIssue> issues) {
