 ...
 */
public final class ChartTimeCursor {

    public static final String CURSOR_LINE_ID = "timeCursorLine";
    public static final String CURSOR_LABEL_ID = "timeCursorLabel";
    public static final Color CURSOR_COLOR = Color.web("#555555");
    public static final double CURSOR_WIDTH = 1.0;
     ...
     */
    public static StackPane install(XYChart<Number, Number> chart, ChartTimeCursor[] out) {
