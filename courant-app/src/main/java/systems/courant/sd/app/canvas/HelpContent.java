...
public final class HelpContent {
    ...
    private static TextFlow simulationSettingsContent() {
        return new TextFlow(
                ...
                bold("Parameters:\n"),
                plain("  \u2022 "), bold("Start Time"), plain(" \u2014 when the simulation begins (default 0)\n"),
                plain("  \u2022 "), bold("Stop Time"), plain(" \u2014 when the simulation ends\n"),
                plain("  \u2022 "), bold("DT (Time Step)"),
                plain(" \u2014 the integration step size. Smaller values give "
                        + "more accuracy but take longer\n"),
                plain("  \u2022 "), bold("Time Unit"),
