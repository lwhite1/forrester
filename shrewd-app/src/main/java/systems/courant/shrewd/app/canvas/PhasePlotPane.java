...
public class PhasePlotPane extends BorderPane {
     ...
     */
    static List<String> getVariableNames(SimulationRunner.SimulationResult result) {
     ...
     */
    static double[] extractColumn(SimulationRunner.SimulationResult result, String variableName) {
