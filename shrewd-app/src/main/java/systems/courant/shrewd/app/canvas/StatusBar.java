...
public class StatusBar extends HBox {
    ...
    public void setOnValidationClicked(Runnable handler) {
        validationLabel.setOnMouseClicked(e -> {
            if (handler != null) {
                handler.run();
            }
        });
        validationLabel.setStyle(validationLabel.getStyle()
                + " -fx-cursor: hand;");
    }
