...
class WorkflowModelBuildFxTest {
    ...
    void shouldBuildModelWithAuxiliary(FxRobot robot) {
        ...
        Platform.runLater(() -> {
            ...
            editor.setStockInitialValue("Stock 1", 100);
            editor.addAux();
            editor.setAuxEquation("Aux 1", "Stock_1 * 0.05");
            editor.addFlow("Stock 1", null);
            editor.setFlowEquation("Flow 1", "Aux_1");
    ...
    void shouldBuildExponentialGrowthModel(FxRobot robot) {
        ...
        Platform.runLater(() -> {
            ...
            editor.addAux();
            editor.renameElement("Aux 1", "Growth Rate");
            editor.setAuxEquation("Growth Rate", "0.1");
